...
gondola_mod.name = "Ingeste/Gondola_Mod"
gondola_mod.depth = -10500
gondola_mod.nodeVisibility = "always"
...
function gondola_mod.sprite(room, entity)
    local sprites = {}
...
function gondola_mod.selection(room, entity)
    local active = entity.active
    local gondolaPosition = getGondolaPosition(room, entity)
...
function gondola_mod.nodeSprite(room, entity, node)
    local rightSprite = getRightSprite(room, entity)
    local active = entity.active
