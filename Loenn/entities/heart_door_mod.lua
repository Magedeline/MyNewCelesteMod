...
heartDoor.name = "Ingeste/HeartDoorMod"
heartDoor.depth = 0
heartDoor.nodeLimits = {0, 1}
heartDoor.warnBelowSize = {40, 8}
...
local edgeTexture = "objects/heart_spear_door_mod/edge"
local heartTexture = "objects/heart_spear_door_mod/icon00"
