    ...
    public class BreathingMinigame : Entity
    {
        ...
        public IEnumerator Routine()
        {
            ...
            if (!breathingMinigame.winnable)
            {
                ...
                {
                    if (breathingMinigame.rumbler != null)
                        breathingMinigame.rumbler.Strength = Calc.Approach(Convert.ToSingle(breathingMinigame.rumbler.Strength), 1f, 2f * Engine.DeltaTime);
        ...
        private IEnumerator ShowText(int num)
        {
            ...
            text = Dialog.Clean("CH6_GONDOLA_FEATHER_" + num);
            yield return 0.1f;
