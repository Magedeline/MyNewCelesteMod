    ...
    public class PlayerDashAssist : Entity
    {
        ...
        public override void Update()
        {
            ...
            else
            {
                ...
                if (timer > 0.20000000298023224 && !snapshotActive)
                    EnableSnapshot();
        ...
        {
            // Optimized audio snapshot with delay check
            if (!snapshotActive && timer > 0.1f) // Prevent rapid toggling
            {
                snapshotActive = true;
            }
        }
        ...
        private void DisableSnapshot()
        {
            if (!snapshotActive)
                return;
            // Delay before disabling to prevent audio pops
