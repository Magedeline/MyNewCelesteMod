...
{
    [CustomEntity("IngesteHelper/NPC07_Maddy_Mirror")]
    public class Npc07MaddyMirror : Entity
    {
        private const string donetalking = "maddy_mirrorDoneTalking";
        ...
        public Npc07MaddyMirror(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("MADDY_07_MIRROR");
