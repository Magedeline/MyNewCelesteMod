...
{
    [CustomEntity("IngesteHelper/NPC08_Madeline_Plateau")]
    public class Npc08MadelinePlateau : Entity
    {
        private const string donetalking = "madeline_plateauDoneTalking";
        ...
        public Npc08MadelinePlateau(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("MADELINE_08_PLATEAU");
