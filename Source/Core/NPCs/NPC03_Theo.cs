...
{
    [CustomEntity("IngesteHelper/NPC03_Theo")]
    public class Npc03Theo : Entity
    {
        ...
        public Npc03Theo(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("THEO_03_MIRROR");
