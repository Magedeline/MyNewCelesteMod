...
{
    [CustomEntity("IngesteHelper/NPC16_Oshiro")]
    public class Npc16Oshiro : Entity
    {
        private const string donetalking = "oshiroDoneTalking";
        ...
        public Npc16Oshiro(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("OSHIRO_16_CORE");
