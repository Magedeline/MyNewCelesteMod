...
{
    [CustomEntity("IngesteHelper/NPC17_Theo")]
    public class Npc17Theo : Entity
    {
        ...
        public Npc17Theo(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("THEO_16_CORE");
