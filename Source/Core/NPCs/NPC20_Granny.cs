...
{
    [CustomEntity("IngesteHelper/NPC20_Granny")]
    public class Npc20Granny : Entity
    {
        private const string donetalking = "grannyDoneTalking";
        ...
        public Npc20Granny(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("GRANNY_20_FAREWELL");
