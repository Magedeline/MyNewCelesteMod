...
{
    [CustomEntity("IngesteHelper/NPC20_Asriel")]
    public class Npc20Asriel : Entity
    {
        private const string donetalking = "asrielDoneTalking";
        ...
        public Npc20Asriel(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("ASRIEL_20_FAREWELL");
