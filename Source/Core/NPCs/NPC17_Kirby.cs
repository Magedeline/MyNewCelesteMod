...
{
    [CustomEntity("IngesteHelper/NPC16_Kirby")]
    public class Npc16Kirby : Entity
    {
        private const string donetalking = "kirbyDoneTalking";
        ...
        public Npc16Kirby(EntityData data, Vector2 offset) : base(data.Position + offset)
        {
            setupSprite();
            setupCollision();
            Depth = 100;
        ...
        private IEnumerator talkcoroutine(global::Celeste.Player player)
        {
            ...
            yield return Textbox.Say("KIRBY_16_CORE");
