...
public class ColorBlock : Entity
{
	...
	public ColorBlock(EntityData data, Vector2 offset)
		: this(
			...
			data.HexColor(nameof(color), Calc.HexToColor("6969ee")),
			data.Float(nameof(alpha), defaultValue: 1.0f),
	...
	public override void Render() => Draw.Rect(base.X, base.Y, width, height, color * alpha);
}
