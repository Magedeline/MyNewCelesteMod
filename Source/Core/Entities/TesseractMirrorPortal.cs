...
{
  [CustomEntity("Ingeste/TesseractMirrorPortal")]
  public class TesseractMirrorGateway : Entity
  {
    ...
    private TesseractMirrorGateway.Debris[] debris = new TesseractMirrorGateway.Debris[50];
    ...
    private TesseractMirrorGateway.Curtain curtain;
    ...
    {
      base.Added(scene);
      scene.Add((Entity) (this.curtain = new TesseractMirrorGateway.Curtain(this.Position)));
    ...
    {
            TesseractMirrorGateway templeMirrorPortal = this;
    ...
    public override void Render()
    {
      ...
      {
        TesseractMirrorGateway.Debris debri = this.debris[index];
        if (debri.Enabled)
        {
    ...
    private void OnPlayer(global::Celeste.Player player)
    {
      ...
      this.Scene.Add((Entity)new CS07_MirrorPortal(player, this));
    }
    ...
    private class Curtain : Solid
    {
      ...
      public override void Update()
      {
        ...
        if (!this.Collidable)
          return;
        global::Celeste.Player player1;
        if ((player1 = this.CollideFirst<global::Celeste.Player>(this.Position + new Vector2(-1f, 0.0f))) != null && player1.OnGround() && (double) Input.Aim.Value.X > 0.0)
        {
        ...
        {
          global::Celeste.Player player2;
          if ((player2 = this.CollideFirst<global::Celeste.Player>(this.Position + new Vector2(1f, 0.0f))) == null || !player2.OnGround() || (double) Input.Aim.Value.X >= 0.0)
            return;
      ...
      public void Drop()
      {
        ...
        while ((player = this.CollideFirst<global::Celeste.Player>(this.Position)) != null && !flag)
        {
          this.Collidable = false;
