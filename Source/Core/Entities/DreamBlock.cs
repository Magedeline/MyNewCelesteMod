...
{
    [CustomEntity("Ingeste/DreamBlock")]
    [Tracked]
	public class DreamBlock : Solid
	{
		...
		public bool BlockedCheck()
		{
            ...
            global::Celeste.Player player = base.CollideFirst<global::Celeste.Player>();
		...
		public IEnumerator Activate()
		{
			...
			for (float p = 1f; p > 0f; p -= Engine.DeltaTime * 0.5f)
			{
				...
				if (level.OnInterval(0.1f))
				{
					...
					{
						level.ParticlesFG.Emit(global::Celeste.Strawberry.P_WingsBurst, new Vector2(base.X + (float)num, base.Y + base.Height * this.whiteHeight + 1f));
						num += 4;
					}
				}
				if (level.OnInterval(0.1f))
