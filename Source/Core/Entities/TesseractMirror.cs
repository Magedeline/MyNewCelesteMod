...
{
  [CustomEntity("Ingeste/TesseractMirror")]
  public class TesseractMirror : Entity
  {
    ...
    public TesseractMirror(EntityData e, Vector2 offset)
    ...
    {
      base.Added(scene);
      scene.Add((Entity) new TesseractMirror.Frame(this));
    }
    ...
    {
      private TesseractMirror mirror;

      public Frame(TesseractMirror mirror)
      {
        this.mirror = mirror;
        this.Depth = 8995;
      }
