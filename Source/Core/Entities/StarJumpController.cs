...
[CustomEntity("Ingeste/StarClimbControl")]
[Tracked(true)]
...
public class StarClimbGraphicsController : Entity
{
  ...
  private void updateBlockFill()
  {
    ...
    for (int index1 = 0; index1 < StarClimbGraphicsController.rays.Length; ++index1)
    {
      ...
      Vector2 vector22 = new Vector2(StarClimbGraphicsController.mod(StarClimbGraphicsController.rays[index1].X - this.level.Camera.X * 0.9f, 480f) - 80f, StarClimbGraphicsController.mod(StarClimbGraphicsController.rays[index1].Y - this.level.Camera.Y * 0.7f, 580f) - 200f);
