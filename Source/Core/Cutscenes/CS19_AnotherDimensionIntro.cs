...
namespace DesoloZantas.Core.Core.Cutscenes
{
  public class Cs19AnotherDimensionIntro : CutsceneEntity
  {
    ...
    private IEnumerator cutscene(Level level)
    {
      ...
      yield return (object) Textbox.Say("CH19_LANDING", new Func<IEnumerator>(cs10MoonIntro.charaTurns), new Func<IEnumerator>(cs10MoonIntro.charaVanishes));
    ...
    public override void OnEnd(Level level)
    {
      ...
      level.Session.SetFlag("another_dimension_intro");
    }
