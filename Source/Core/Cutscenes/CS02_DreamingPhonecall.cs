...
namespace DesoloZantas.Core.Core.Cutscenes
{
  public class Cs04DreamingPhonecall : CutsceneEntity
  {
    ...
    public override void OnBegin(Level level)
    {
      ...
      this.flag.Flags.Contains("CH4_DREAM_PHONECALL_DONE");
    ...
    private IEnumerator cutscene(Level level)
    {
      ...
      yield return Textbox.Say("CH4_DREAM_PHONECALL", showChara);
      if (evil != null)
      {
        if (level.Session.Area.Mode == AreaMode.Normal)
    ...
    public override void OnEnd(Level level)
    {
      ...
      level.Session.Audio.Music.Event = "event:/Ingeste/music/lvl2/awake";
      level.Session.Audio.Ambience.Event = "event:/Ingeste/env/02_awake";
