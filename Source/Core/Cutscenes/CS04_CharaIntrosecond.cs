...
{
    public class CS04_CharaIntroSecond : CutsceneEntity
    {
        #region Constants
        ...
        private const string MUSIC_EVENT = "event:/Ingeste/music/lvl4/chara_warning";
        ...
        public CS04_CharaIntroSecond(CharaChaser charaChaser) : base(true, false)
        {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("CH4_CHARA_2ND_INTRO", new Func<IEnumerator>[] {
                TurnAround,
                RevealChara,
            });
        ...
        public override void OnEnd(Level level)
        {
            try
            {
                ...
                level.Session.SetFlag("chara_intro_warning", true);
            }
            catch (Exception ex)
            {
        ...
        private class ExitSequencer : Entity
        {
            ...
            private readonly CS04_CharaIntroSecond parent;

            public ExitSequencer(CharaChaser charaChaser, Level level, CS04_CharaIntroSecond parent)
            {
                chara = charaChaser;
                this.level = level;
                this.parent = parent;
