using AngryOshiro = Celeste.AngryOshiro;
using DesoloZantas.Core.Core.Entities;

namespace DesoloZantas.Core.Core.Cutscenes
{
    public class CS05_OshiroRooftop(NPC oshiro) : CutsceneEntity
    {
        ...
        private IEnumerator Cutscene(Level level)
        {
            ...
            yield return Textbox.Say("CH5_OSHIRO_START_CHASE", CharaAppear, BadelineFaceChara, KirbyWalkAwayWithGroup, KirbyLookAtChara, OshiroEnterAndAsk, OshiroGetsAngry);
        ...
        private IEnumerator CharaAppear()
        {
            ...
            evil = new CharaDummy(new Vector2(oshiro.X - 40f, level.Bounds.Bottom - 60));
        ...
        private void SetChaseMusic()
        {
            ...
            obj.Session.Audio.Music.Event = "event:/Ingeste/music/lvl5/oshiro_chase";
        ...
        public override void OnEnd(Level level)
        {
            ...
            player = base.Scene.Tracker.GetEntity<global::Celeste.Player>();
            if (player != null)
            {
