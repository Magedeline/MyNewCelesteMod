...
{
    public class WaveFazePage05 : WaveFazePage
    {
        private List<Display> displays = new List<Display>();

        public WaveFazePage05()
        {
        ...
        {
            ActiveFont.DrawOutline(Dialog.Clean("WAVEFAZE_PAGE5_TITLE"), new Vector2(128f, 100f), Vector2.Zero, Vector2.One * 1.5f, Color.White, 2f, Color.Black);
            foreach (Display display in displays)
                display.Render();
        }
        ...
        private class Display
        {
            ...
            public WaveFazePlaybackTutorial Tutorial;
            ...
            public Display(Vector2 position, string text, string tutorial, Vector2 tutorialOffset)
            {
                ...
                Tutorial = new WaveFazePlaybackTutorial(tutorial, tutorialOffset, new Vector2(1f, 1f), new Vector2(1f, 1f), new Vector2(1f, 1f), new Vector2(1f, 1f));
